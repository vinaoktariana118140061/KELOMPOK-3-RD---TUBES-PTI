            ...
            <div class="inputan">
                <div id="container_login" class="form-group center">
                    ...
                    <form action="{{ route('insert-data') }}" method="POST">
                        ...
                        <input class="nama" type="text" name="nama" id="user" class="form-control" value="{{ old('nama') }}" required>
                        @error('nama')
                        <div class="e-nama2">
                            {{$message}}
                        </div>
                        ...
                        <input class="alamat" type="text" name="alamat" id="Alamat" class="form-control" value="{{ old('alamat') }}" required>
                        @error('alamat')
                        <div class="e-alamat2">
                            {{$message}}
                        </div>
                        ...
                        <input class="r1" type="radio" id="peralatan" name="kategori" value="peralatan" required>
                        <label class="peralatan" for="peralatan">Peralatan</label>
                        <input class="r2" type="radio" id="bahan" name="kategori" value="bahan" required>
